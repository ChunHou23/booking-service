...
func routes(app *config.AppConfig) http.Handler {
	...
	mux.Get("/general-suite", handlers.Repo.GeneralSuite)
	mux.Get("/junior-suite", handlers.Repo.JuniorSuite)
	...
	mux.Route("/admin", func(mux chi.Router) {
		...
		mux.Post("/reservations/{src}/{id}/show", handlers.Repo.AdminPostShowReservations)
	})
